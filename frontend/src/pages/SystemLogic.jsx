...
const flowSteps = [
  { icon: Brain, title: '1. Student Input', desc: 'Weekly behavioural questionnaire — sleep, energy, workload, focus, social, stress.', color: 'bg-primary/10 text-primary border-primary/20' },
  { icon: BarChart3, title: '2. Model Processing', desc: 'Responses scored into a distress score (0–100). Historical data builds a trajectory profile.', color: 'bg-primary/10 text-primary border-primary/20' },
